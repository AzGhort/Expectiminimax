package conquest.bot.playground.testing;
...
import conquest.bot.playground.expectiminimax.Evaluator;
import conquest.bot.playground.expectiminimax.Expectiminimax;
import conquest.bot.playground.expectiminimax.Game;
import conquest.bot.playground.expectiminimax.Generator;
import conquest.bot.playground.expectiminimax.Possibility;
import conquest.bot.playground.expectiminimax.Strategy;
...
class TugGenerator implements Generator<TugState, Boolean> {
    static final List<Boolean> allActions = Arrays.asList(true, false);
...
class Tug {
	public static void main(String[] args) {
		...
		Strategy<TugState, Boolean> emm = new Expectiminimax<>(game, new TugGenerator(), new TugEvaluator(), 1); 
